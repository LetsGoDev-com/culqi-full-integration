<div class="wrap about-wrap full-width-layout">
	<div style="float: right;">
		<img src="<?php echo esc_html( FULLCULQI_URL ); ?>resources/assets/images/culqi_logo.png" alt="FullCulqi Logo" />
	</div>
		...
		<div class="feature-section one-col is-wide wp-clearfix one-col">
			<div class="col">
				<div class="alignleft" style="margin-right: 20px;">
					<img src="<?php echo esc_html( FULLCULQI_URL ); ?>resources/assets/images/welcome.png" alt="FullCulqi Logo" style="width:100%;" />
				</div>
					...
					<table>
						<tr><th>
							<div class="alignright" style="margin-left: 20px;">
								<img src="<?php echo esc_html( FULLCULQI_URL ); ?>resources/assets/images/alert.png" alt="alert" style="margin-bottom: 0;" />
							</div>
